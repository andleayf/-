...
$('nav .nav_down').mouseenter(function () {
    ...
    $(this).children('img').attr('src', 'http://localhost:8080/Videos/before/img/nav_down2.png');
});
$('nav .nav_down').mouseleave(function () {
    $('#nav_down').stop().slideUp();
    $(this).children('img').attr('src', 'http://localhost:8080/Videos/before/img/nav_down.png');
});
